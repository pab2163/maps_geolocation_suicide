...
df = dplyr::mutate(df, 
                   event_cat1_lead1week = ifelse(ID==9999 & week_start_wednesday== as.Date('1900-01-01'),
                                                 0, event_cat1_lead1week),
                   event_cat1 = ifelse(ID==9999 & week_start_wednesday== as.Date('1900-01-01'),
                                                 0, event_cat1),
                   event_cat1_lead2week = ifelse(ID==9999 & week_start_wednesday== as.Date('1900-01-01'),
                                                 0, event_cat1_lead2week),
                   event_cat1_lead3week = ifelse(ID==9999 & week_start_wednesday== as.Date('1900-01-01'),
